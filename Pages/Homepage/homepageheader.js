const homepageHeader=`
    <div class="shop-container">
        <p class="nav-sections"><a id="shopping-cart-icon" href='#'><img class="icons" src="../../white_icons/cart.png" /></a></p>
    </div>

        <img id="logo" src="../../Logos/winkstalogo.png" />

    <nav class="home-nav">
        <span class="menu-icon-holder">
            <img class="icons" id="menu-icon" onclick="opendropdown()" src="../../white_icons/menu.png" />
            <img class="icons" id="close-icon" onclick="closedropdown()"src="../../white_icons/small/cross-small.png" />
        </span>
